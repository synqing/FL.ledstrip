...
// Array of Crameri palette pointers
const TProgmemRGBGradientPalettePtr gCrameriPalettes[] = {
...
const uint8_t gCrameriPaletteCount = sizeof(gCrameriPalettes) / sizeof(TProgmemRGBGradientPalettePtr);
